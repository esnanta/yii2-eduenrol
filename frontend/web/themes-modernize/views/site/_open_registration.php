        ...
        <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home-1" role="tab">
                    <span class="badge bg-success">
                        ...
                        <?= Yii::$app->user->getIsGuest() ?
                            'Login/Sign Up' : 'Login as ' . Yii::$app->user->identity->username;
                        ?>
                    </span>
        </a>
    </li>
    ...
    <div class="tab-pane fade" id="profile-1" role="tabpanel">
        ...
        <ul class="timeline">
            ...
            <li>
                ...
                <p>Setelah langkah pertama, sistem akan mengirim link untuk mengaktifkan akun. Buka email yang diisikan,
                    kemudian klik link yang dikirim.</p>
            </li>
            <li>
                <h3>Login</h3>
