...
class ApplicantGradeController extends Controller
{
    ...
    /**
     * Creates a new ApplicantGrade model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        if(Yii::$app->user->can('create-applicantgrade')){
            $model = new ApplicantGrade;
    ...
    /**
     * Updates an existing ApplicantGrade model.
    ...
    {
        if(Yii::$app->user->can('update-applicantgrade')){
            try {
                $model = $this->findModel($id);
    ...
    /**
     * Deletes an existing ApplicantGrade model.
    ...
    {
        if(Yii::$app->user->can('delete-applicantgrade')){
