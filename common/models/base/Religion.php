...
/**
 * This is the base model class for table "tx_religion".
 *
 * @property integer $id
...
class Religion extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\Applicant::className(), ['religion_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\ApplicantFamily::className(), ['religion_id' => 'id']);
    }
