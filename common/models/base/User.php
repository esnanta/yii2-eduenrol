    ...
    */
    ...
    public function rules()
    {
        return [
            ...
            [['flags', 'confirmed_at', 'blocked_at', 'updated_at', 'created_at', 'last_login_at', 'verlock', 'deleted_by'], 'integer'],
            [['deleted_at'], 'safe'],
    ...
    {
        return $this->hasMany(\common\models\Staff::className(), ['user_id' => 'id']);
    }
