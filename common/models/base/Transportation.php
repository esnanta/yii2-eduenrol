...
/**
 * This is the base model class for table "tx_transportation".
 *
 * @property integer $id
...
class Transportation extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\ApplicantAlmamater::className(), ['transportation_id' => 'id']);
    }
