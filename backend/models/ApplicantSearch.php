...
class ApplicantSearch extends Applicant
{
    ...
    {
        return [
            [['id', 'event_id', 'user_id', 'gender_status', 'date_birth', 'religion_id', 'citizenship_status', 'blood_type', 'height', 'weight', 'head_circle', 'number_of_sibling', 'number_of_dependent', 'number_of_step_sibling', 'birth_order', 'child_status', 'final_status', 'date_final', 'approval_status', 'date_approval', 'approved_by', 'created_at', 'updated_at', 'created_by', 'updated_by', 'verlock'], 'integer'],
            [['email', 'record_number', 'family_card_number', 'identity_number', 'birth_certificate_number', 'title', 'nick_name', 'birth_place', 'address_street', 'address_village', 'address_sub_district', 'address_city', 'address_province', 'phone_number', 'hobby', 'native_language', 'illness', 'disability', 'file_name', 'description', 'uuid'], 'safe'],
        ];
    }
