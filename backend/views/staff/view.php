...
$create = Html::a(
    ...
    ['site/create-reguler'],
    ['class' => 'pull-right detail-button', 'style' => 'padding:0 5px']
);
?>
                ...
                <section class="text-center g-mb-30 g-mb-50--md">
                    <div class="d-inline-block g-pos-rel g-mb-20">
                        ...
                        Html::a(
                            ...
                            ['class' => 'u-badge-v2--lg u-badge--bottom-right g-width-32 
                                g-height-32 g-bg-secondary g-bg-primary--hover g-transition-0_3 
                                g-mb-20 g-mr-20']
                        );
                        ?>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="g-brd-top g-brd-gray-light-v7 mb-0">
                            ...
                            <a class="d-flex align-items-center u-link-v5 g-parent g-py-15 active" href="">
                                <span class="g-font-size-18 g-color-gray-light-v6
                                g-color-primary--parent-hover g-color-primary--parent-active
                                g-mr-15">
                                    <i class="hs-admin-email"></i>
                                </span>
                                <span class="g-color-gray-dark-v6 g-color-primary--parent-hover
                                g-color-primary--parent-active">
                    ...
                    [
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => ($model->active_status != null) ?
                                    $model->getOneActiveStatus($model->active_status) : '',
                                'format' => 'html',
                                'type' => DetailView::INPUT_SELECT2,
                    ...
                    [
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => ($model->gender_status != null) ?
                                    $model->getOneGenderStatus($model->gender_status) : '',
                                'format' => 'html',
                                'type' => DetailView::INPUT_SELECT2,
                    ...
                    [
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => ($model->updated_by != null) ?
                                    common\models\User::getName($model->updated_by) : '',
                                'type' => DetailView::INPUT_HIDDEN,
                                'valueColOptions' => ['style' => 'width:30%']
                            ],
                        ],
