 ...
 * @var common\models\OccupationSearch $searchModel
 */

$this->title = Yii::t('app', 'Occupations');
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a(
                            ...
                            Yii::$app->urlManager->createUrl(['income/view', 'id' => $model->id, 'edit' => 't']),
                            [
                    ...
                    'view' => function ($url, $model) {
                        return Html::a(
                            ...
                            Yii::$app->urlManager->createUrl(['income/view', 'id' => $model->id]),
                            [
