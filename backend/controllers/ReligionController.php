...
class ReligionController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('index-religion')){
    ...
    {
        if(Yii::$app->user->can('view-religion')){
    ...
    {
        if(Yii::$app->user->can('create-religion')){
            $model = new Religion;
    ...
    {
        if(Yii::$app->user->can('update-religion')){
            try {
                $model = $this->findModel($id);
    ...
    {
        if(Yii::$app->user->can('delete-religion')){
