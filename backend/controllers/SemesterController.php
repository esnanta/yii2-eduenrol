...
class SemesterController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('index-semester')){
    ...
    {
        if(Yii::$app->user->can('view-semester')){
    ...
    {
        if(Yii::$app->user->can('create-semester')){
            $model = new Semester;
    ...
    {
        if(Yii::$app->user->can('update-semester')){
            try {
                $model = $this->findModel($id);
    ...
    {
        if(Yii::$app->user->can('delete-semester')){
