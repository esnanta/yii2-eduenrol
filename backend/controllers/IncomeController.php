...
class IncomeController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('index-income')){
    ...
    {
        if(Yii::$app->user->can('view-income')){
    ...
    {
        if(Yii::$app->user->can('create-income')){
            $model = new Income;
    ...
    {
        if(Yii::$app->user->can('update-income')){
            try {
                $model = $this->findModel($id);
    ...
    {
        if(Yii::$app->user->can('delete-income')){
