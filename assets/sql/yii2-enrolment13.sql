...
CREATE TABLE `tx_applicant_document` (
  ...
  KEY `FK_tx_applicant_document_status` (`document_status`),
...
(1,'test',2,'-',1673156816,1673156846,1,1,NULL,NULL,NULL,1);
...
CREATE TABLE `tx_customer` (
  ...
  KEY `FK_tx_customer_gender` (`gender_status`),
...
CREATE TABLE `tx_event` (
  ...
  `is_using_comingsoon` tinyint(1) DEFAULT NULL,
  `days_for_comingsoon` tinyint(2) DEFAULT NULL,
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
insert  into `tx_event`(`id`,`title`,`date_start`,`date_end`,`location`,`content`,`view_counter`,`description`,`is_open_registration`,`is_using_comingsoon`,`days_for_comingsoon`,`created_at`,`updated_at`,`created_by`,`updated_by`,`is_deleted`,`deleted_at`,`deleted_by`,`verlock`) values 
(1,'TA 2021/2022',1577811600,1580403600,'SMAN Modal Bangsa Arun','',NULL,'',2,1,29,1673150043,1673160108,1,1,0,NULL,NULL,8);
...
(1,'admin','ombakrinai@gmail.com','$2y$12$exl6mG/cWOt.DgoW11kiKuRkPKvQ/iYFNj.6FlwHLNtk3IYq8GmoO','JpJ77Y4v9Ffj8zN5lLGb2WN9-sotAgUx',NULL,'::1',0,1525156961,NULL,1527960555,1507741399,1673149402,NULL,0),
