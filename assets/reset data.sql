...
DELETE FROM tx_stock_adjustment_detail;
ALTER TABLE tx_stock_adjustment_detail AUTO_INCREMENT=0;

DELETE FROM tx_stock_adjustment;
ALTER TABLE tx_stock_adjustment AUTO_INCREMENT=0;
...
DELETE FROM tx_stock_opname_detail;
ALTER TABLE tx_stock_opname_detail AUTO_INCREMENT=0;

DELETE FROM tx_stock_opname;
ALTER TABLE tx_stock_opname AUTO_INCREMENT=0;

DELETE FROM tx_work_remold_detail;
ALTER TABLE tx_work_remold_detail AUTO_INCREMENT=0;

DELETE FROM tx_work_remold;
ALTER TABLE tx_work_remold AUTO_INCREMENT=0;

DELETE FROM tx_work_order_detail;
ALTER TABLE tx_work_order_detail AUTO_INCREMENT=0;

DELETE FROM tx_work_order;
ALTER TABLE tx_work_order AUTO_INCREMENT=0;

DELETE FROM tx_work_request_detail;
ALTER TABLE tx_work_request_detail AUTO_INCREMENT=0;

DELETE FROM tx_work_request;
ALTER TABLE tx_work_request AUTO_INCREMENT=0;

DELETE FROM tx_product_detail;
ALTER TABLE tx_product_detail AUTO_INCREMENT=0;

DELETE FROM tx_product;
ALTER TABLE tx_product AUTO_INCREMENT=0;
